...
int main(int argc, char **argv) {
    ...
    app.add_option("warp_index", warp_index_path, "warpfile index path")->type_name("FILEPATH");
    ...
    IFile* fwarpindex = nullptr;
    IFile* file = nullptr;

    if (warp_index_path != "") {
        fwarpindex = open_file(warp_index_path.c_str(), flag, mode);
        LSMT::WarpFileArgs args(fwarpindex, findex, nullptr, fdata);
